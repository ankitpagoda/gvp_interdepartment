    ...
    return (
        ...
        >
            ...
            <div style={{ marginBottom: '2.5rem' }}>
                <h1 style={{ fontSize: '1.75rem', fontWeight: '800', margin: 0 }}>Room Request :- MR00</h1>
            </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <div style={{
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem', marginBottom: '1.25rem' }}>
                        <div>
                            <label style={labelStyle}>Required from :- DD/MM/YYYY</label>
                            <input type="text" style={inputStyle} />
                        </div>
                        <div>
                    ...
                    <div style={fieldGroupStyle}>
                        <label style={labelStyle}>Request for :- Person Name</label>
                        <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                            <input type="text" style={inputStyle} />
                            <button style={plusButtonStyle}>
                                <Plus size={20} strokeWidth={3} />
...
export default RoomRequestSection;

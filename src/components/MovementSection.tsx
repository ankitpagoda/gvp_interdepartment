    ...
    return (
        ...
        >
            ...
            <div style={{ marginBottom: '2.5rem' }}>
                <h1 style={{ fontSize: '1.75rem', fontWeight: '800', margin: 0 }}>Movement Register :- MV00</h1>
            </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <div style={{
                    ...
                    <div style={fieldGroupStyle}>
                        <label style={labelStyle}>Given to :- Name</label>
                        <input type="text" style={inputStyle} />
                    </div>

                    <div style={fieldGroupStyle}>
                        <label style={labelStyle}>Given to :- Department</label>
                        <input type="text" style={inputStyle} />
                    </div>
